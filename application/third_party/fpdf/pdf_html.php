...
function OpenTag($tag, $attr)
{
    ...
    switch($tag){
        ...
        case 'TABLE': // TABLE-BEGIN
            if( isset($attr['BORDER']) && $attr['BORDER'] != '' ) $this->tableborder=$attr['BORDER'];
            else $this->tableborder=0;
            break;
        case 'TR': //TR-BEGIN
            break;
        case 'TD': // TD-BEGIN
            if( isset($attr['WIDTH']) && $attr['WIDTH'] != '' ) $this->tdwidth=($attr['WIDTH']/4);
            else $this->tdwidth=40; // SET to your own width if you need bigger fixed cells
            if( isset($attr['HEIGHT']) && $attr['HEIGHT'] != '') $this->tdheight=($attr['HEIGHT']/6);
