...
//                $where = array();
            ...
            case Super::$ADMIN_CODE:
                //ถ้าเป็น admin ให้เห็นแค่ cpn ของตัวเอง
                $where = array("user_type_code <> " => Super::$SUPER_ADMIN_CODE);
                break;
            default:
                break;
        }
...
//            }
    ...
    public function clearBeforeInsertAndUpdate($array) {
        ...
        $permissionMap = 
                array(
                    Super::$SUPER_ADMIN_CODE => array(Super::$SUPER_ADMIN_CODE, Super::$ADMIN_CODE, Super::$USER),
                    Super::$ADMIN_CODE => array(Super::$ADMIN_CODE, Super::$USER),
                    Super::$USER => array()
                );
