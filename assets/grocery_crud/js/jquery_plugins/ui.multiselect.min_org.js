...
(function(b) {
    b.widget("ui.multiselect", {options: {sortable: !0, searchable: !0, doubleClickable: !0, animated: "fast", show: "slideDown", hide: "slideUp", dividerLocation: 0.6, availableFirst: !1, nodeComparator: function(a, b) {
            ...
            this.availableActions = b('<div class="actions ui-widget-header ui-helper-clearfix"><input type="text" class="search empty ui-widget-content ui-corner-all"/><a href="#" class="add-all">' + b.ui.multiselect.locale.addAll + "</a></div>").appendTo(this.availableContainer);
            ...
            this.options.sortable && this.selectedList.sortable({placeholder: "ui-state-highlight", axis: "y", update: function() {
            ...
            var c = b(this), d = a.children("li"), a = d.map(function() {
                return b(this).text().toLowerCase()
            }), e = b.trim(c.val().toLowerCase()), g = [];
            e ? (d.hide(), a.each(function(a) {
                -1 < this.indexOf(e) && g.push(a)
            }), b.each(g, function() {
                b(d[this]).show()
            })) : d.show()
