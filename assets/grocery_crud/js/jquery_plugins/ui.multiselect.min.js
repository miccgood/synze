...
(function(b) {
    b.widget("ui.multiselect", {options: {sortable: !0, searchable: !0, doubleClickable: !0, animated: "fast", show: "slideDown", hide: "slideUp", dividerLocation: 0.5, availableFirst: !1, nodeComparator: function(a, b) {
                var d = a.text(), e = b.text();
                return d == e ? 0 : d < e ? -1 : 1
            }}, _create: function() {
            var sizeSelected = this.element.find("option").not(":selected").size();
            this.element.hide().css({height: ((sizeSelected * 50) % 400) + 200, width : 750});
