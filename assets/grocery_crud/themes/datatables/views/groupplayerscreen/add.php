...
<div class='form-content form-div'>
	<?php echo form_open( $insert_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
		<div>
                     <div class='form-field-box even' id="resolution_field_box">
                        <div class='form-display-as-box' id="resolution_display_as_box">
                                Layout Resolution : 
                        </div>
                        <div class='form-input-box' id="resolution_input_box">
                            <div class="readonly_label" id="field-resolution"></div>
                        </div>
                        <div class='clear'></div>
                    </div>      

                    <script type="text/javascript">
                        $("#field-resolution").html(groupPlayerWidth + " : " + groupPlayerHeight );
                    </script>
			<?php
			$counter = 0;
