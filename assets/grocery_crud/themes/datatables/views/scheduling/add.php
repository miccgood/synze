<?php
	...
	$this->set_js_lib($this->default_javascript_path.'/jquery_plugins/config/jquery.noty.config.js');
        ...
        $this->set_js_lib($this->default_javascript_path.'/jquery_plugins/bootstrap.min.js');

        $this->set_js_lib($this->default_javascript_path.'/jquery_plugins/bootstrap-datetimepicker.min.js');
        
        
        $this->set_css($this->default_css_path.'/jquery_plugins/bootstrap-combined.min.css');
    $this->set_css($this->default_css_path.'/jquery_plugins/bootstrap-datetimepicker.min.css');
