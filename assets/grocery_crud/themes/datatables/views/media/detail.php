...
//                    $("#text_input_field_box, #media_filename_temp_field_box").show();
                    ...
                    if($type === "Web page" || $type === "Streaming"){
                        ...
                        $("#media_path_field_box").removeClass("even").addClass("odd").show();
                        $("#text_input_field_box").hide();
...
//                        $("#field-media_path").val("gen");
            ...
            $("#crudForm").bind("submit", function(){
                ...
                var $type = $('#field-media_type').val();
                if($type === "scrolling text" || $type === "Web page" || $type === "RSS feed" || $type === "Streaming"){
...
<script type="text/javascript">
        ...
        $(function(){
            var max = 99;
            var min = 0;
//            var transparencyValue = $("#transparency").val();
            $('#transparency').spinner({
                min: min, 
                max: max, 
                numberFormat: "d2",
                change: function( event, ui ) {
                    var value = $("#transparency").spinner("value");
                    if(value){
                        if(value > max){
                            $("#transparency").spinner("value", 99);
                        } else if(value < min) {
                            $("#transparency").spinner("value", 0);
                        }
                    } else {
                        $("#transparency").spinner("value", 0);
                    }
...
//            $("#transparency").spinner("value", transparencyValue);
