...
<?php 	if(!$this->unset_back_to_list) { ?>
			<div class='form-button-box'>
				<input type='button' value='<?php echo $this->l('form_save_and_next'); ?>' class='ui-input-button' id="save-and-next"/>
			</div>
			<div class='form-button-box'>
...
<script>
	...
	var list_url = '<?php echo $list_url?>';
        ...
        var $next_url = '<?php echo base_url("index.php/groupplayerscreen?tmn_grp_id=")?>';
        
	var message_alert_add_form = "<?php echo $this->l('alert_add_form')?>";
	var message_insert_error = "<?php echo $this->l('insert_error')?>";
        
        var $id = $("#field-tmn_grp_ID").val();
